var Colyseus = (() => {
  ...
  // ../../My2ddemo/game/node_modules/@colyseus/schema/build/umd/index.js
  var require_umd = __commonJS({
    "../../My2ddemo/game/node_modules/@colyseus/schema/build/umd/index.js"(exports, module) {
      (function(global, factory) {
        ...
        var encode3 = /* @__PURE__ */ Object.freeze({
          __proto__: null,
          boolean: boolean$1,
          float32: float32$1,
          float64: float64$1,
        ...
        function utf8Read3(bytes, offset, length) {
          var string2 = "", chr = 0;
        ...
        function string(bytes, it) {
          ...
          var value = utf8Read3(bytes, it.offset, length);
          it.offset += length;
          return value;
        }
        ...
        var decode3 = /* @__PURE__ */ Object.freeze({
          __proto__: null,
          arrayCheck,
          boolean,
          float32,
                    ...
                    if (change.op === exports2.OPERATION.ADD || isSchema) {
                      ...
                      if (containerIndexes.has(fieldIndex)) {
                        ...
                        if (value["$changes"]) {
                          ...
                          encode3[type2](filteredBytes, value);
                        }
                      }
                    }
        ...
        var Reflection2 = (
          /** @class */
          function(_super) {
            __extends(Reflection3, _super);
            function Reflection3() {
              var _this = _super !== null && _super.apply(this, arguments) || this;
              _this.types = new ArraySchema();
              return _this;
            }
            Reflection3.encode = function(instance) {
              var _a;
              var rootSchemaType = instance.constructor;
              var reflection = new Reflection3();
            ...
            Reflection3.decode = function(bytes, it) {
            ...
            ], Reflection3.prototype, "types", void 0);
            __decorate([
              type("number", reflectionContext)
            ], Reflection3.prototype, "rootType", void 0);
            return Reflection3;
          }(Schema)
        );
        ...
        exports2.Reflection = Reflection2;
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/index.mjs
  var esm_exports = {};
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/legacy.mjs
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/errors/ServerError.mjs
  var CloseCode;
  (function(CloseCode2) {
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/msgpack/index.mjs
  ...
  // ../../cocos/jie-cocos/temp/empty-ws.mjs
  var empty_ws_default = void 0;

  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/transport/WebSocketTransport.mjs
  var WebSocket = globalThis.WebSocket || empty_ws_default;
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/Connection.mjs
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/Protocol.mjs
  var Protocol;
  (function(Protocol2) {
  ...
  function utf8Read2(view, offset) {
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/serializer/Serializer.mjs
  var serializers = {};
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/core/nanoevents.mjs
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/core/signal.mjs
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/Room.mjs
  ...
  var Room = class _Room {
    constructor(name, rootSchema) {
      ...
      __publicField(this, "hasJoined", false);
    ...
    onMessageCallback(event) {
      ...
      if (code === Protocol.JOIN_ROOM) {
        let offset = 1;
        const reconnectionToken = utf8Read2(bytes, offset);
        offset += utf8Length2(reconnectionToken);
        this.serializerId = utf8Read2(bytes, offset);
        offset += utf8Length2(this.serializerId);
        if (!this.serializer) {
        ...
        const it = { offset: 1 };
        const code2 = import_schema.decode.number(bytes, it);
        const message = import_schema.decode.string(bytes, it);
        ...
        const type = context.get(import_schema.decode.number(bytes, it));
        ...
        const it = { offset: 1 };
        const type = import_schema.decode.stringCheck(bytes, it) ? import_schema.decode.string(bytes, it) : import_schema.decode.number(bytes, it);
        const message = bytes.length > it.offset ? decode(event.data, it.offset) : void 0;
        this.dispatchMessage(type, message);
  ...
  // ../../My2ddemo/game/node_modules/httpie/xhr/index.mjs
  var xhr_exports = {};
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/HTTP.mjs
  var HTTP = class {
    ...
    request(method, path, options = {}) {
      return xhr_exports[method](this.client["getHttpEndpoint"](path), this.getOptions(options)).catch((e) => {
        const status = e.statusCode;
        const message = e.data?.error || e.statusMessage || e.message;
        if (!status && !message) {
          throw e;
        }
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/Storage.mjs
  var storage;
  function getStorage() {
    if (!storage) {
      try {
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/Auth.mjs
  var __initialized, __initializationPromise, __signInWindow, __events;
  var Auth = class {
    constructor(http) {
      ...
      __privateAdd(this, __initializationPromise);
      __privateAdd(this, __signInWindow);
    ...
    onChange(callback) {
      ...
      if (!__privateGet(this, __initialized)) {
        __privateSet(this, __initializationPromise, new Promise((resolve, reject) => {
    ...
    async signInWithProvider(providerName, settings = {}) {
      return new Promise((resolve, reject) => {
        ...
        const onMessage = (event) => {
          ...
          __privateSet(this, __signInWindow, void 0);
  ...
  __initializationPromise = new WeakMap();
  __signInWindow = new WeakMap();
  __events = new WeakMap();

  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/3rd_party/discord.mjs
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/Client.mjs
  ...
  var Client = class {
    ...
    async consumeSeatReservation(response, rootSchema, reuseRoomInstance) {
  ...
  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/serializer/SchemaSerializer.mjs
  ...
  var SchemaSerializer = class {
    ...
    handshake(bytes, it) {
      if (this.state) {
        const reflection = new import_schema2.Reflection();
        reflection.decode(bytes, it);
      } else {
        this.state = import_schema2.Reflection.decode(bytes, it);
      }
    }
  };

  // ../../My2ddemo/game/node_modules/colyseus.js/build/esm/serializer/NoneSerializer.mjs
...
if (typeof globalThis !== 'undefined' && typeof Colyseus !== 'undefined') { globalThis.Colyseus = Colyseus; }
