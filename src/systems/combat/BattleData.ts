...
import { ZONE_PL } from '../../core/config';
import { Item, EquipSlot } from '../items/Inventory';
import { makeSetId } from '../items/SetSystem';
...
/** 副本某阶通关奖励（gold/exp/loot），按区域PL与阶数缩放。3 阶：1=4普通 2=2精英 3=BOSS。 */
export function dungeonStageReward(dungeonId: number, stage: number): { gold: number; exp: number; loot: Item[] } {
  ...
  // 奖励曲线：普通阶(1) 温和、精英阶(2) 跃升、BOSS阶(3) 最高
