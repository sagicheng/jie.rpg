...
const ZONE1_ENEMIES: NamedEnemyDef[] = [
  {
    name: '低级虚',
    type: '杂妖', element: '无',
...
const ZONE2_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE3_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE4_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE5_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE6_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE8_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE9_ENEMIES: NamedEnemyDef[] = [
  {
...
const ZONE10_11_ENEMIES: NamedEnemyDef[] = [
  {
...
/** 专属装备注册表（按名字索引） */
const NAMED_EQUIPS: Record<string, NamedEquipDrop> = {
  // 区域①Boss掉落
  '虚夜护腕': {
...
/** 专属材料注册表 */
const NAMED_MATERIALS: Record<string, { desc: string }> = {
