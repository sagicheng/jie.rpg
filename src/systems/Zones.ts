...
export interface ZoneNPC {
  x: number; y: number;
  name: string;
  role: 'merchant' | 'return_point' | 'quest' | 'lore' | 'craft' | 'side_quest' | 'enhance';
  dialogue: Array<{
    speaker: string;
    text: string;
...
export const ZONE_CONFIGS: Record<number, ZoneConfig> = {
  ...
  1: {
    ...
    enemies: [
      ...
      // ── 区域Boss（右下角） ──
      { name: '大虚·亚丘卡斯', type: '妖将', element: '无', x: 0.93, y: 0.88, isBoss: true },
    ],
    gathering: [
      { x: 0.1, y: 0.2, type: '矿脉' }, { x: 0.3, y: 0.5, type: '药草' }, { x: 0.6, y: 0.8, type: '矿脉' },
      { x: 0.9, y: 0.25, type: '药草' }, { x: 1.2, y: 0.7, type: '矿脉' }, { x: 1.5, y: 0.15, type: '药草' },
      { x: 1.8, y: 0.45, type: '灵木' }, { x: 2.1, y: 0.8, type: '药草' },
      { x: 2.5, y: 0.3, type: '矿脉' }, { x: 2.8, y: 0.65, type: '灵木' },
      { x: 0.45, y: 0.35, type: '灵脉' }, { x: 2.2, y: 0.25, type: '药草' },
    ],
    exits: [
  ...
  2: {
    ...
    gathering: [
      { x: 0.89, y: 0.49, type: '灵脉' }, { x: 0.71, y: 0.79, type: '矿脉' },
      { x: 0.11, y: 0.61, type: '灵木' }, { x: 0.63, y: 0.33, type: '灵木' },
      { x: 0.53, y: 0.78, type: '灵脉' }, { x: 0.53, y: 0.11, type: '灵木' },
      { x: 0.8, y: 0.4, type: '药草' }, { x: 0.3, y: 0.6, type: '药草' },
    ],
    exits: [
  ...
  3: {
    ...
    gathering: [
      { x: 0.39, y: 0.52, type: '矿脉' }, { x: 0.34, y: 0.07, type: '矿脉' },
      { x: 0.64, y: 0.68, type: '灵木' }, { x: 0.89, y: 0.33, type: '灵木' },
      { x: 0.55, y: 0.55, type: '灵木' }, { x: 0.88, y: 0.08, type: '药草' },
      { x: 0.3, y: 0.49, type: '药草' }, { x: 0.81, y: 0.39, type: '灵脉' },
    ],
    exits: [
  ...
  4: {
    ...
    gathering: [
      { x: 0.15, y: 0.25, type: '灵木' }, { x: 0.4, y: 0.35, type: '矿脉' },
      { x: 0.65, y: 0.55, type: '药草' }, { x: 0.85, y: 0.8, type: '灵木' },
      { x: 1.2, y: 0.3, type: '矿脉' }, { x: 1.5, y: 0.7, type: '药草' },
      { x: 1.8, y: 0.4, type: '灵木' }, { x: 2.2, y: 0.8, type: '矿脉' },
      { x: 2.6, y: 0.25, type: '药草' }, { x: 0.3, y: 0.65, type: '灵脉' },
      { x: 1.7, y: 0.15, type: '灵木' }, { x: 2.0, y: 0.6, type: '灵脉' },
    ],
    exits: [
  ...
  5: {
    ...
    gathering: [
      { x: 0.21, y: 0.27, type: '灵脉' }, { x: 0.93, y: 0.9, type: '矿脉' },
      { x: 0.61, y: 0.27, type: '药草' }, { x: 0.3, y: 0.49, type: '灵脉' },
      { x: 0.94, y: 0.81, type: '灵木' }, { x: 0.9, y: 0.27, type: '灵木' },
      { x: 0.51, y: 0.16, type: '灵木' }, { x: 0.13, y: 0.5, type: '灵脉' },
    ],
    exits: [
  ...
  6: {
    ...
    gathering: [
      { x: 0.93, y: 0.1, type: '药草' }, { x: 0.59, y: 0.6, type: '灵脉' },
      { x: 0.79, y: 0.91, type: '灵木' }, { x: 0.12, y: 0.34, type: '矿脉' },
      { x: 0.21, y: 0.19, type: '药草' }, { x: 0.21, y: 0.27, type: '矿脉' },
      { x: 0.9, y: 0.73, type: '灵脉' }, { x: 0.58, y: 0.28, type: '灵脉' },
    ],
    exits: [
  ...
  7: {
    ...
    gathering: [
      { x: 0.1, y: 0.2, type: '矿脉' }, { x: 0.3, y: 0.6, type: '药草' },
      { x: 0.5, y: 0.15, type: '灵木' }, { x: 0.7, y: 0.8, type: '矿脉' },
      { x: 0.9, y: 0.45, type: '药草' }, { x: 1.2, y: 0.7, type: '灵木' },
      { x: 1.5, y: 0.25, type: '矿脉' }, { x: 1.9, y: 0.55, type: '药草' },
      { x: 2.2, y: 0.15, type: '灵木' }, { x: 2.5, y: 0.8, type: '矿脉' },
      { x: 0.4, y: 0.45, type: '灵脉' }, { x: 1.7, y: 0.35, type: '灵脉' },
    ],
    exits: [
  ...
  8: {
    ...
    gathering: [
      { x: 0.39, y: 0.08, type: '药草' }, { x: 0.42, y: 0.17, type: '矿脉' },
      { x: 0.29, y: 0.43, type: '灵脉' }, { x: 0.81, y: 0.67, type: '灵木' },
      { x: 0.12, y: 0.65, type: '灵木' }, { x: 0.75, y: 0.12, type: '灵木' },
      { x: 0.94, y: 0.42, type: '灵木' }, { x: 0.81, y: 0.21, type: '矿脉' },
    ],
    exits: [
  ...
  9: {
    ...
    gathering: [
      { x: 0.21, y: 0.54, type: '灵脉' }, { x: 0.07, y: 0.92, type: '灵木' },
      { x: 0.23, y: 0.69, type: '灵脉' }, { x: 0.47, y: 0.27, type: '药草' },
      { x: 0.49, y: 0.81, type: '灵脉' }, { x: 0.22, y: 0.64, type: '药草' },
      { x: 0.25, y: 0.43, type: '矿脉' }, { x: 0.33, y: 0.06, type: '灵脉' },
    ],
    exits: [
  ...
  10: {
    ...
    gathering: [
      { x: 0.1, y: 0.2, type: '矿脉' }, { x: 0.3, y: 0.55, type: '灵木' },
      { x: 0.55, y: 0.15, type: '药草' }, { x: 0.75, y: 0.7, type: '矿脉' },
      { x: 0.95, y: 0.35, type: '灵木' }, { x: 1.2, y: 0.8, type: '药草' },
      { x: 1.5, y: 0.4, type: '矿脉' }, { x: 1.8, y: 0.65, type: '灵木' },
      { x: 2.1, y: 0.2, type: '药草' }, { x: 2.5, y: 0.5, type: '矿脉' },
      { x: 0.6, y: 0.45, type: '灵脉' }, { x: 2.3, y: 0.85, type: '灵脉' },
    ],
    exits: [
  ...
  11: {
    ...
    gathering: [
      { x: 0.38, y: 0.55, type: '矿脉' }, { x: 0.33, y: 0.65, type: '药草' },
      { x: 0.19, y: 0.52, type: '药草' }, { x: 0.12, y: 0.2, type: '药草' },
      { x: 0.79, y: 0.9, type: '药草' }, { x: 0.65, y: 0.86, type: '灵脉' },
      { x: 0.57, y: 0.08, type: '灵脉' }, { x: 0.9, y: 0.3, type: '灵木' },
    ],
    exits: [
  ...
  12: {
    ...
    gathering: [
      { x: 0.9, y: 0.09, type: '矿脉' }, { x: 0.78, y: 0.49, type: '灵木' },
      { x: 0.37, y: 0.32, type: '灵脉' }, { x: 0.58, y: 0.54, type: '药草' },
      { x: 0.69, y: 0.91, type: '灵脉' }, { x: 0.19, y: 0.32, type: '矿脉' },
      { x: 0.72, y: 0.77, type: '药草' }, { x: 0.14, y: 0.06, type: '灵脉' },
    ],
    exits: [
  ...
  13: {
    ...
    gathering: [
      { x: 0.1, y: 0.25, type: '矿脉' }, { x: 0.3, y: 0.55, type: '灵木' },
      { x: 0.55, y: 0.3, type: '药草' }, { x: 0.8, y: 0.7, type: '矿脉' },
      { x: 1.1, y: 0.4, type: '灵木' }, { x: 1.4, y: 0.2, type: '药草' },
      { x: 1.7, y: 0.6, type: '矿脉' }, { x: 2.0, y: 0.35, type: '灵木' },
      { x: 2.4, y: 0.7, type: '药草' }, { x: 2.7, y: 0.2, type: '矿脉' },
      { x: 0.5, y: 0.65, type: '灵脉' }, { x: 2.2, y: 0.85, type: '灵脉' },
    ],
    exits: [
  ...
  14: {
    ...
    gathering: [
      { x: 0.15, y: 0.56, type: '灵木' }, { x: 0.67, y: 0.35, type: '药草' },
      { x: 0.08, y: 0.37, type: '灵木' }, { x: 0.06, y: 0.07, type: '药草' },
      { x: 0.65, y: 0.14, type: '灵木' }, { x: 0.62, y: 0.82, type: '药草' },
      { x: 0.81, y: 0.36, type: '矿脉' }, { x: 0.72, y: 0.19, type: '灵木' },
    ],
    exits: [
  ...
  15: {
    ...
    gathering: [
      { x: 0.47, y: 0.93, type: '灵脉' }, { x: 0.33, y: 0.42, type: '灵脉' },
      { x: 0.71, y: 0.52, type: '矿脉' }, { x: 0.2, y: 0.32, type: '灵脉' },
      { x: 0.83, y: 0.07, type: '灵木' }, { x: 0.73, y: 0.89, type: '灵脉' },
      { x: 0.83, y: 0.23, type: '灵脉' }, { x: 0.42, y: 0.07, type: '矿脉' },
    ],
    exits: [
  ...
  16: {
    ...
    gathering: [
      { x: 0.1, y: 0.3, type: '矿脉' }, { x: 0.3, y: 0.65, type: '灵木' },
      { x: 0.55, y: 0.25, type: '药草' }, { x: 0.8, y: 0.55, type: '矿脉' },
      { x: 1.1, y: 0.7, type: '灵木' }, { x: 1.4, y: 0.35, type: '药草' },
      { x: 1.7, y: 0.15, type: '矿脉' }, { x: 2.0, y: 0.65, type: '灵木' },
      { x: 2.3, y: 0.45, type: '药草' }, { x: 2.6, y: 0.8, type: '矿脉' },
      { x: 0.45, y: 0.55, type: '灵脉' }, { x: 2.1, y: 0.2, type: '灵脉' },
    ],
    exits: [
  ...
  17: {
    ...
    gathering: [
      { x: 0.88, y: 0.52, type: '灵脉' }, { x: 0.13, y: 0.24, type: '矿脉' },
      { x: 0.3, y: 0.74, type: '灵木' }, { x: 0.35, y: 0.82, type: '灵木' },
      { x: 0.8, y: 0.81, type: '药草' }, { x: 0.36, y: 0.16, type: '矿脉' },
      { x: 0.8, y: 0.75, type: '矿脉' }, { x: 0.37, y: 0.79, type: '药草' },
    ],
    exits: [
  ...
  18: {
    ...
    gathering: [
      { x: 0.35, y: 0.87, type: '灵脉' }, { x: 0.59, y: 0.87, type: '灵脉' },
      { x: 0.12, y: 0.34, type: '矿脉' }, { x: 0.12, y: 0.05, type: '灵脉' },
      { x: 0.86, y: 0.26, type: '矿脉' }, { x: 0.33, y: 0.75, type: '灵脉' },
      { x: 0.41, y: 0.32, type: '灵脉' }, { x: 0.51, y: 0.23, type: '药草' },
    ],
    exits: [
  ...
  19: {
    ...
    gathering: [
      { x: 0.1, y: 0.3, type: '矿脉' }, { x: 0.3, y: 0.55, type: '灵木' },
      { x: 0.55, y: 0.2, type: '药草' }, { x: 0.8, y: 0.6, type: '矿脉' },
      { x: 1.1, y: 0.35, type: '灵木' }, { x: 1.4, y: 0.75, type: '药草' },
      { x: 1.7, y: 0.45, type: '矿脉' }, { x: 2.0, y: 0.2, type: '灵木' },
      { x: 2.3, y: 0.55, type: '药草' }, { x: 2.6, y: 0.8, type: '矿脉' },
      { x: 0.5, y: 0.4, type: '灵脉' }, { x: 2.2, y: 0.7, type: '灵脉' },
    ],
    exits: [
  ...
  20: {
    ...
    gathering: [
      { x: 0.21, y: 0.66, type: '矿脉' }, { x: 0.36, y: 0.89, type: '药草' },
      { x: 0.16, y: 0.5, type: '药草' }, { x: 0.24, y: 0.66, type: '矿脉' },
      { x: 0.28, y: 0.7, type: '灵木' }, { x: 0.34, y: 0.63, type: '灵木' },
      { x: 0.69, y: 0.2, type: '灵脉' }, { x: 0.62, y: 0.16, type: '药草' },
    ],
    exits: [
  ...
  21: {
    ...
    gathering: [
      { x: 0.49, y: 0.16, type: '药草' }, { x: 0.82, y: 0.69, type: '灵木' },
      { x: 0.73, y: 0.32, type: '灵木' }, { x: 0.78, y: 0.88, type: '矿脉' },
      { x: 0.07, y: 0.72, type: '药草' }, { x: 0.71, y: 0.9, type: '灵木' },
      { x: 0.07, y: 0.62, type: '矿脉' }, { x: 0.21, y: 0.87, type: '灵脉' },
    ],
    exits: [
