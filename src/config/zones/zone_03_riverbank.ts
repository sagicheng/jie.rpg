...
import { shop } from './shop';
  export const zone03: ZoneConfig = {
    ...
    npcs: [
      { x: 0.45, y: 0.35, id: 'npc_m03', name: '铁云堂', role: 'merchant', dialogue: [
      ...
      { x: 0.7, y: 0.5, id: 'npc_q03', name: '苍山', role: 'quest', dialogue: [
      ...
      { x: 0.55, y: 0.38, id: 'npc_f03', name: '流浪锻', role: 'enhance', dialogue: [{ speaker: '流浪锻', text: '装备的强化、精炼、分解都交给我吧。好的装备是战斗的基础。', choices: [{ text: '打开强化工坊', callback: 'openEnhance' }, { text: '离开', callback: 'closeDialogue' }] },] },
      { x: 0.2, y: 0.7, id: 'npc_s10', name: '虚探', role: 'side_quest', dialogue: [
        { speaker: '虚探', text: '我受伤了……帮我采集药草疗伤，我告诉你虚的弱点。' },
      ]},
      { x: 0.65, y: 0.8, id: 'npc_s11', name: '流翁', role: 'side_quest', dialogue: [
        { speaker: '流翁', text: '去流魂街需要斩魄刀。帮我收集矿脉，我替你磨一把临时的。' },
      ]},
      { x: 0.15, y: 0.5, id: 'npc_s12', name: '铁裁', role: 'lore', dialogue: [
        { speaker: '铁裁', text: '斩魄刀——死神灵魂的具现化。浅打是它的初始形态。' },
        { speaker: '铁裁', text: '北边的穿界门通往尸魂界。流魂街是所有灵魂的起点。' },
      ]},
      { x: 0.8, y: 0.65, id: 'npc_s05', name: '魂影', role: 'lore', dialogue: [
