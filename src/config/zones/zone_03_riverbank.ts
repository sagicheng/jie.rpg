  ...
  export const zone03: ZoneConfig = {
    ...
    npcs: [
      { x: 0.45, y: 0.35, id: 'npc_m03', role: 'merchant', dialogue: [
        { text: '店长让我在这里设摊。河川敷的虚比镇子里强，装备也得跟上。', choices: [{ text: '交易', callback: 'openShop' }] },
      ],
