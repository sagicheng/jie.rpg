  ...
  export const zone02: ZoneConfig = {
    ...
    npcs: [
      { x: 0.45, y: 0.35, id: 'npc_m02', role: 'merchant', dialogue: [
        { text: '嘿嘿，我从浦原大叔那里进了些货。虽然不太会用，但装备还是靠谱的！', choices: [{ text: '交易', callback: 'openShop' }] },
      ],
