...
export const MAIN_QUESTS: Record<string, QuestDef> = {
  ...
  'prologue_awaken': {
    ...
    type: 'main',
    chapter: 0,
    desc: '你在空座町苏醒，能看见虚的存在。云行商愿意帮你觉醒斩魄刀。',
    objectives: [
      { type: 'talk', target: 'npc_m01', count: 1, desc: '与云行商对话' },
    ],
  ...
  'ch1_hollow_threat': {
    ...
    type: 'main',
    chapter: 1,
    desc: '云隐请你帮忙清除空座町游荡的虚。证明你有成为死神的资格。',
    objectives: [
  ...
  'shikai_trial': {
    ...
    type: 'main',
    chapter: 1,
    desc: '云行商感受到你的斩魄刀中沉睡的力量。去流魂街完成试炼，唤醒它的真名。',
    objectives: [
  ...
  'ch2_enter_river': {
    ...
    type: 'main',
    chapter: 2,
    desc: '进入流魂街，在铁心的注视下击败强敌，证明你有资格获得始解。',
    objectives: [
  ...
  'ch2_squad_eleven': {
    ...
    type: 'main',
    chapter: 2,
    desc: '铁心认可了你，但他还要看看你的极限。击败叛逆队员和大虚。',
    objectives: [
  ...
  'ch3_court_training': {
    ...
    type: 'main',
    chapter: 3,
    desc: '冬凌要求你在静灵庭完成高强度训练。击败叛死神和虚群。',
    objectives: [
  ...
  'bankai_trial': {
    ...
    type: 'main',
    chapter: 3,
    desc: '炎叟总队长说，真正的死神能在极限中觉醒卍解。在静灵庭的终极试炼中证明自己。',
    objectives: [
  ...
  'ch4_enter_hueco': {
    ...
    type: 'main',
    chapter: 4,
    desc: '巧手商告诉你，虚圈中有一种禁忌的力量——虚化。去吧，接受虚的试炼。',
    objectives: [
  ...
  'ch7_hell_guardians': {
    ...
    type: 'main',
    chapter: 7,
    desc: '残影·祈请求你清理地狱中的咎人和地狱犬——它们是终焉之兽的爪牙。',
    objectives: [
...
export const SIDE_QUESTS: Record<string, QuestDef> = {
  // ① 空座町
  'side_1_shop_herb': {
    id: 'side_1_shop_herb', name: '雨雀的请求', type: 'side', chapter: 1,
    desc: '雨雀需要采集药草补充云行商的店铺的库存。',
    objectives: [{ type: 'collect', target: '药草', count: 5, desc: '采集药草' }],
    rewards: { gold: 300, exp: 100, items: [{ id: 'potion_small', name: '回复药', count: 3 }] },
    acceptFrom: 'npc_s02', completeAt: 'npc_s02', zoneRequired: 1,
  },
  'side_1_hollow_hunt': {
    ...
    acceptFrom: 'npc_s03', completeAt: 'npc_s03', zoneRequired: 1,
  },
  'side_1_charm': {
    ...
    rewards: { gold: 500, exp: 200 },
    acceptFrom: 'npc_s04', completeAt: 'npc_s04', zoneRequired: 1,
  },

  // ② 流魂街
  'side_4_beauty': { id: 'side_4_beauty', name: '弓亲的审美', type: 'side', chapter: 4, desc: '绫濑川弓亲需要灵木制作武器配饰。', objectives: [{ type: 'collect', target: 'any', count: 5, desc: '采集灵木' }], rewards: { gold: 400, exp: 180 }, acceptFrom: 'npc_s13', completeAt: 'npc_s13', zoneRequired: 4 },
  'side_4_bandits': { id: 'side_4_bandits', name: '流魂街治安', type: 'side', chapter: 4, desc: '桧佐木修兵请你清理流魂街的强盗。', objectives: [{ type: 'kill', target: '流魂街强盗', count: 5, desc: '击败强盗' }], rewards: { gold: 500, exp: 450 }, acceptFrom: 'npc_s14', completeAt: 'npc_s14', zoneRequired: 4 },
  'side_4_healing': { id: 'side_4_healing', name: '吉良的伤势', type: 'side', chapter: 4, desc: '吉良井鹤需要药草治伤。', objectives: [{ type: 'collect', target: 'any', count: 5, desc: '采集药草' }], rewards: { gold: 350, exp: 150, items: [{ id: 'antidote', name: '解毒草', count: 4 }] }, acceptFrom: 'npc_q05', completeAt: 'npc_q05', zoneRequired: 4 },

  // ③ 静灵庭
  'side_7_rangiku': { id: 'side_7_rangiku', name: '松本的休息', type: 'side', chapter: 7, desc: '松本乱菊想要药草和灵木。', objectives: [{ type: 'collect', target: 'any', count: 7, desc: '采集补给' }], rewards: { gold: 500, exp: 250, items: [{ id: 'potion_medium', name: '强效回复药', count: 2 }] }, acceptFrom: 'npc_s22', completeAt: 'npc_s22', zoneRequired: 7 },
  'side_7_zaraki': { id: 'side_7_zaraki', name: '碎岳的热身', type: 'side', chapter: 7, desc: '碎岳让你找强敌热身。', objectives: [{ type: 'kill', target: '叛逆死神', count: 6, desc: '击败叛逆死神' }], rewards: { gold: 700, exp: 750, items: [{ id: 'bronze_bracer', name: '护廷手甲', count: 1 }] }, acceptFrom: 'npc_q06', completeAt: 'npc_q06', zoneRequired: 7 },
  'side_7_unohana': { id: 'side_7_unohana', name: '花静的药剂', type: 'side', chapter: 7, desc: '花静需要灵脉样本。', objectives: [{ type: 'collect', target: 'any', count: 6, desc: '收集灵脉' }], rewards: { gold: 600, exp: 700 }, acceptFrom: 'npc_s20', completeAt: 'npc_s20', zoneRequired: 7 },

  // ④ 虚圈
  'side_10_yammy': { id: 'side_10_yammy', name: '牙密的练习', type: 'side', chapter: 10, desc: '牙密拿亚丘卡斯练手。', objectives: [{ type: 'kill', target: '亚丘卡斯', count: 10, desc: '击败亚丘卡斯' }], rewards: { gold: 700, exp: 350 }, acceptFrom: 'npc_s26', completeAt: 'npc_s26', zoneRequired: 10 },
  'side_10_ruby': { id: 'side_10_ruby', name: '露比的触手', type: 'side', chapter: 10, desc: '露比的触手被虚群缠住了。', objectives: [{ type: 'kill', target: '基利安', count: 5, desc: '清理基利安' }], rewards: { gold: 600, exp: 300, items: [{ id: 'potion_medium', name: '强效回复药', count: 3 }] }, acceptFrom: 'npc_q09', completeAt: 'npc_q09', zoneRequired: 10 },
  'side_10shawlong': { id: 'side_10shawlong', name: '萧隆的教导', type: 'side', chapter: 10, desc: '萧隆库方需要灵脉研究。', objectives: [{ type: 'collect', target: 'any', count: 6, desc: '收集灵脉' }], rewards: { gold: 500, exp: 280, items: [{ id: 'jade_ring', name: '虚闪戒指', count: 1 }] }, acceptFrom: 'npc_m11', completeAt: 'npc_m11', zoneRequired: 10 },

  // ⑤ 空座町·归
  'side_13_jackie': { id: 'side_13_jackie', name: '贾姬的靴子', type: 'side', chapter: 13, desc: '贾姬需要矿脉做新靴子。', objectives: [{ type: 'collect', target: 'any', count: 6, desc: '采集矿脉' }], rewards: { gold: 600, exp: 300 }, acceptFrom: 'npc_s29', completeAt: 'npc_s29', zoneRequired: 13 },
  'side_13_yukio': { id: 'side_13_yukio', name: '雪绪的数据', type: 'side', chapter: 13, desc: '雪绪需要战斗数据。', objectives: [{ type: 'kill', target: '完现虚', count: 13, desc: '击败完现虚' }], rewards: { gold: 700, exp: 3130, items: [{ id: 'potion_large', name: '高级回复药', count: 2 }] }, acceptFrom: 'npc_s30', completeAt: 'npc_s30', zoneRequired: 13 },
  'side_13_chad': { id: 'side_13_chad', name: '茶渡的调整', type: 'side', chapter: 13, desc: '茶渡泰虎需要灵木稳定右臂。', objectives: [{ type: 'collect', target: 'any', count: 13, desc: '采集灵木' }], rewards: { gold: 1300, exp: 300, items: [{ id: 'royal_ring', name: '显灵戒指', count: 1 }] }, acceptFrom: 'npc_s31', completeAt: 'npc_s31', zoneRequired: 13 },

  // ⑥ 无形帝国
  'side_16_as': { id: 'side_16_as', name: '艾斯的恐惧', type: 'side', chapter: 16, desc: '艾斯·诺特让你采集灵脉对抗恐惧。', objectives: [{ type: 'collect', target: 'any', count: 7, desc: '采集灵脉' }], rewards: { gold: 800, exp: 400 }, acceptFrom: 'npc_s33', completeAt: 'npc_s33', zoneRequired: 16 },
  'side_16_bambi': { id: 'side_16_bambi', name: '邦比爱塔的爆炸', type: 'side', chapter: 16, desc: '邦比爱塔让你炸圣兵。', objectives: [{ type: 'kill', target: '圣兵', count: 16, desc: '击败圣兵' }], rewards: { gold: 900, exp: 450 }, acceptFrom: 'npc_q17', completeAt: 'npc_q17', zoneRequired: 16 },
  'side_16_liltotto': { id: 'side_16_liltotto', name: '莉托托的食物', type: 'side', chapter: 16, desc: '莉托托饿了，需要药草和灵木。', objectives: [{ type: 'collect', target: 'any', count: 8, desc: '收集食物' }], rewards: { gold: 1000, exp: 500, items: [{ id: 'ruby_ring', name: '星十字戒指', count: 1 }] }, acceptFrom: 'npc_m15', completeAt: 'npc_m15', zoneRequired: 16 },

  // ⑦ 地狱
  'side_19_jailer': { id: 'side_19_jailer', name: '越狱的咎人', type: 'side', chapter: 19, desc: '地狱狱卒让你抓回越狱的咎人。', objectives: [{ type: 'kill', target: '咎人', count: 19, desc: '击败咎人' }], rewards: { gold: 1200, exp: 600, items: [{ id: 'dark_ring', name: '狱戒指', count: 1 }] }, acceptFrom: 'npc_m18', completeAt: 'npc_m18', zoneRequired: 19 },
  'side_19_soul': { id: 'side_19_soul', name: '墓碑', type: 'side', chapter: 19, desc: '被囚的灵魂想刻一块墓碑。', objectives: [{ type: 'collect', target: 'any', count: 6, desc: '收集矿脉' }], rewards: { gold: 1000, exp: 500 }, acceptFrom: 'npc_s34', completeAt: 'npc_s34', zoneRequired: 19 },
  'side_19_gatekeeper': { id: 'side_19_gatekeeper', name: '守门人的请求', type: 'side', chapter: 19, desc: '守门人让你清理混沌兽。', objectives: [{ type: 'kill', target: '混沌兽', count: 4, desc: '击败混沌兽' }], rewards: { gold: 1500, exp: 1950, items: [{ id: 'abyss_necklace', name: '狱魂项链', count: 1 }] }, acceptFrom: 'npc_q15', completeAt: 'npc_q15', zoneRequired: 19 },
};
...
export const DAILY_QUESTS: Record<string, QuestDef> = {
  ...
  daily_herb:         { id: 'daily_herb',         name: '药草采集',   type: 'daily', chapter: 0, desc: '云行商的店铺需要补充药草库存。', objectives: [{ type: 'collect', target: '药草', count: 5, desc: '采集药草' }], rewards: { gold: 150, exp: 60 }, zoneRequired: 1 },
